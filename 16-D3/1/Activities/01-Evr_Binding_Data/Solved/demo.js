...
d3.select("ul").selectAll("li")
    .each(function(d, i) {          // d is the tag item to be picked up, i is the index.
      console.log("element", this);  // "element" will pick up and spit out the whole HTML element
      console.log("data", d);
      console.log("index", i);
    });
...
d3.select("ul").selectAll("li")
    .data(arr)
    .text(function(d) {   //For 'd', just think of "item_from_array"
      return d;           //For 'd', just think of "item_from_array"
    });
...
d3.select("ul").selectAll("li")
    .data(arr)
    .text(function(d) {    //For 'd', just think of "item_from_array" 
      return d + 1000;     //For 'd', just think of "item_from_array"
    });
