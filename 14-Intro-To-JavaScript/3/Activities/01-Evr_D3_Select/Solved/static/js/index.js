...
// Added during class:
// setting the var to just this:
var text3 = d3.select(".text1");
// allows you to just set the new text with shorter code:
text3.text("Hey Cory!")
...
//Added during class:
// selects the href link and shows it:
d3.select(".my-link>a").attr("href");
