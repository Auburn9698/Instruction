...
// Print results
console.log(`============`);
console.log(`There are ${numGoodMovies} movies with a good rating.`);
console.log(`There are ${numOKMovies} with an OK rating.`);
console.log(`There are ${numBadMovies} with a bad rating.`);
console.log(`===========`);
